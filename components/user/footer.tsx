    ...
    <footer className="bg-gray-100 dark:bg-gray-800 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">CampusDabba</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Connecting students with delicious, homemade meals from local cooks.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/search" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                  Find Food
                </Link>
              </li>
              <li>
                <Link href="/orders" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                  My Orders
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-300">&copy; 2023 CampusDabba. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
